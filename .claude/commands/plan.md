...
**`docs/design/phases/${PHASE}/phase_context.md`** — compact read (~1-2K tokens) loaded by ALL implementation agents instead of the full BRD + IMPLEMENTATION_GUIDELINES:
```markdown
