...
HAS_CODE_REVIEW=$([ -f "agent_state/phases/${PHASE}/reports/quality_gate.md" ] && echo true || echo false)
...
[ "$HAS_CODE_REVIEW" = "true" ] && COMPLETED_ITEMS+=("Code review complete: agent_state/phases/${PHASE}/reports/quality_gate.md")
